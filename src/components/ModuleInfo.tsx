...
const defaultFlashcards = [
  ...
  {
    front: 'What is JSX?',
    back: 'A syntax extension for JavaScript that looks similar to XML or HTML.',
  },
      ...
      <div className="with-navbar module-info-container max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-stretch w-full">
          ...
          <div className="flex-1 min-w-0">
            <div
              className={`module-flex ${img_position === 'right' ? 'flex-row-reverse' : 'flex-row'} flex`}
            >
            ...
            {quizQuestions && quizQuestions.length > 0 && (
              <div className="card bg-base-100 shadow-none max-w-md w-full mx-auto">
                <div
                  ...
                  style={{ backgroundColor: '#ffe680', borderRadius: '12px' }}
                >
